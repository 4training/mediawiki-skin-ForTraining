 ...
 */
class ForTrainingVariablesModule extends ResourceLoaderSkinModule {
	/**
	...
	protected function getLessVars( ResourceLoaderContext $context ) {
		...
		// Backdrop image
		$backdrop = $config->get( 'ForTrainingBackdropImage' );
	...
	public function getDefinitionSummary( ResourceLoaderContext $context ) {
		...
		$summary[] = [
			'ForTrainingBackdropImage' => $this->getConfig()->get( 'ForTrainingBackdropImage' )
		];
		return $summary;
	}
}
